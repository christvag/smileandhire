      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">Worky Happy</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Connect talented professionals with amazing opportunities. 
              AI-powered job matching and comprehensive HR management platform.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 Worky Happy. All rights reserved.
          </p>
